...
DEFAULT_FEATURE_CATALOG: tuple[FeatureCatalogEntry, ...] = (
    ...
    FeatureCatalogEntry(
        feature_name="short_interest_change_pct",
        feature_family="short",
        feature_group="crowding",
        description="Variation relative du short interest par rapport au rapport précédent.",
        input_tables=("short_interest_history",),
        output_table="short_features_daily",
    ),
    FeatureCatalogEntry(
        feature_name="short_squeeze_score",
        feature_family="short",
        feature_group="squeeze",
        description="Score composite simple de pression short basé sur days_to_cover et short_volume_ratio.",
        input_tables=("short_interest_history", "daily_short_volume_history"),
        output_table="short_features_daily",
    ),
    FeatureCatalogEntry(
        feature_name="short_pressure_zscore",
        feature_family="short",
        feature_group="pressure",
        description="Z-score rolling de la pression short via short_volume_ratio.",
        input_tables=("daily_short_volume_history",),
        output_table="short_features_daily",
    ),
    FeatureCatalogEntry(
        feature_name="days_to_cover_zscore",
        feature_family="short",
        feature_group="pressure",
        description="Z-score rolling de days_to_cover.",
        input_tables=("short_interest_history",),
        output_table="short_features_daily",
    ),
    FeatureCatalogEntry(
