...
from stock_quant.pipelines.finra_short_interest_pipeline import BuildFinraShortInterestPipeline


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build FINRA short interest tables for stock-quant-oop.")
    parser.add_argument("--db-path", default=None, help="Path to DuckDB database file.")
    parser.add_argument("--source-market", default="regular", choices=["regular", "otc", "both"], help="Source market filter.")
