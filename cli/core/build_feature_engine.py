...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build technical and merged research features.")
...
def main() -> int:
    ...
    if args.verbose:
        print(f"[build_feature_engine] project_root={config.project_root}")
        print(f"[build_feature_engine] db_path={config.db_path}")
