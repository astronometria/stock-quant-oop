...
from stock_quant.pipelines.news_raw_pipeline import BuildNewsRawPipeline


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build news_articles_raw for stock-quant-oop.")
...
def main() -> int:
    ...
    if args.verbose:
        print(f"[build_news_raw] project_root={config.project_root}")
        print(f"[build_news_raw] db_path={config.db_path}")
