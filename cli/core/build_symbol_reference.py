...
from stock_quant.infrastructure.repositories.duckdb_symbol_reference_repository import (
    DuckDbSymbolReferenceRepository,
)
from stock_quant.pipelines.build_symbol_reference_pipeline import (
    BuildSymbolReferencePipeline,
)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build symbol_reference for stock-quant-oop."
    )
...
def main() -> int:
    ...
    with DuckDbUnitOfWork(session_factory) as uow:
        ...
        repository = DuckDbSymbolReferenceRepository(uow.connection)
