...
log_file="logs/write_inplace_pipeline_refactor_${timestamp}.log"
exec > >(tee "${log_file}") 2>&1

echo "===== DATE ====="
date
echo "===== WRITE INPLACE PIPELINE REFACTOR SCRIPT ====="

cat > scripts/refactor_inplace_pipeline_classes.py <<'PYEOF'
...
chmod +x scripts/refactor_inplace_pipeline_classes.py

echo "WROTE: scripts/refactor_inplace_pipeline_classes.py"
echo "===== DONE ====="
